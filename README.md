...
|:---|:---|:---|
| ☕ **Java — Модуль 1** | Кванториум | `08.2024 — 05.2025` |
| ☕ **Java — Модуль 2** | Кванториум | `08.2025 — 05.2026` |
| 🛠 **DevOps простым языком** | Stepik | `03.2025 — 04.2025` |
| 🐍 **Поколение Python: курс для начинающих** | Stepik | `04.2026 — 05.2026` |
